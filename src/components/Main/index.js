...
import * as B from '../style/main'
import Hogwarts from '../../images/Hogwarts.jpg'
import logo from '../../images/logo-hogwarts.png'
...
export function Main() {
  ...
  return (
    <B.Container>
        <B.WrapHogwarts>
            <B.SubTitle>Hogwarts</B.SubTitle>
            <B.BoxCastle>
                <B.ParagraphCastle>A Escola de Hogwarts é abrigada pelo Castelo de Hogwarts, 
                    ...
                    para resistir o efeitos do tabu.</B.ParagraphCastle>
                <B.BoxHogwarts>
                    <B.ImgHogwarts src={Hogwarts} alt="Castelo de Hogwarts" />
                </B.BoxHogwarts>
            </B.BoxCastle>
                
            <B.WrapBlazon>
                <B.BoxBlazon>
                    <B.ImgBlazon src={logo} alt="Brasão da Escola de Hogwarts" />
                </B.BoxBlazon>
                <B.ParagraphBlazon>O brasão de Hogwarts mostra o animal símbolo de cada 
                    ...
                    já que o local testemunhou séculos de magia antiga.</B.ParagraphBlazon>
            </B.WrapBlazon>
            
            <B.BoxSchool>
                <B.ParagraphSchool>A escola tem uma quantidade considerável de feitiços e 
